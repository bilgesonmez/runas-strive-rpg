...
/**
 * Represents the monster Mega Saurus.
 *
 * @author bilgesonmez
 * @version 1.0
 */
public class MegaSaurus extends PlayerMonster {
    /**
     ...
     */
    public MegaSaurus(String name, int initialHealth, List<MonsterSkills> skills) {
