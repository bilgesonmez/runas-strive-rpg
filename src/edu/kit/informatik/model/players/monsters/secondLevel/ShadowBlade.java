...
/**
 * Represents the monster Shadow Blade.
 *
 * @author bilgesonmez
 * @version 1.0
 */
public class ShadowBlade extends PlayerMonster {
    /**
     ...
     */
    public ShadowBlade(String name, int initialHealth, List<MonsterSkills> skills) {
