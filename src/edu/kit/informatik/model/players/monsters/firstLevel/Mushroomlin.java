...
/**
 * Represents the monster Mushroomlin.
 *
 * @author bilgesonmez
 * @version 1.0
 */
public class Mushroomlin extends PlayerMonster {
    /**
     ...
     */
    public Mushroomlin(String name, int initialHealth, List<MonsterSkills> skills) {
